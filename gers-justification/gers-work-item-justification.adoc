...
The following components of the Global Entity Reference System model and framework are addressed in the GERS Community Standard. The source of the content for the draft Community Standard is the July 2025 of the Overture GERS release.
