...
offer two critical capabilities: Reverse lookup of source features and to enhance ability to join content from multiple geospatial data repositories.
...
This Community Standard DOES NOT specify how the the GERS IDs, bridge files, registry and so forth are physically stored. Current implementations use storage and communication formats such as GeoParquet and GeoJSON and storage technologies such as Azure blob storage.
