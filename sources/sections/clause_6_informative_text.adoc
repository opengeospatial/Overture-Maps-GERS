...
Each theme can be semantically subtyped as shown in the following table.
...
|Places	    | place
|Transportation	| segment, connector. Segment contains three subtypes - road, rail, and water which contain familiar categories of transportation data: highways, footways, cycleways, railways, ferry routes, and public transportation.
|===
