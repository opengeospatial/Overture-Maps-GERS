...
An implementation of the GERS model can change this equation by specifying a mechanism for defining persistent, unique identifiers for any geospatial entity as well as a supporting infrastructure such as a registry of those IDs and related metadata.
