== GERS Core Requirements Class

This Clause defines the GERS Core Requirements Class. Requirements are focused on the elements required to implement the GERS model. This clause does not define requirements for conflation, work flows, or storage/processing technologies.
