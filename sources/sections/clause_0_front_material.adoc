...
. The schema to structure geospatial data into a datastore that includes the unique GERS IDs and that is consistent with other OGC/ISO Standards.

In summary, GERS defines/provides a universal framework for structuring and matching map data across different geospatial technologies and systems.
