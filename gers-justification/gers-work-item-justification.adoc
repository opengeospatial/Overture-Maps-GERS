...
An implementation of the GERS model can change this equation by specifying a mechanism for defining persistent, unique identifiers for any geospatial entity as well as a supporting infrastructure such as a regsitry of those IDs and related metadata.
...
The key benefits of implementing a GERS framework as identified by the Overture Foundation community are as follows.
