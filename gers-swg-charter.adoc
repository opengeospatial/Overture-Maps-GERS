...
approach is the `precisely` implementation (See <<annex-a,Annex A>>).

A more extensive list of implementations of the GERS framework/approach are provided in <<annex-b,Annex B>>.
