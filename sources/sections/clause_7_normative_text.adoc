...
| requirements_class-gers-id  | Requirements for generation of a GERS ID      | Mandatory
| requirements_class-gers-bridge | Requirements for Bridge Files              | Mandatory
| requirements_class-gers-registry | Requirements for the Registry File       | Optional
|===
