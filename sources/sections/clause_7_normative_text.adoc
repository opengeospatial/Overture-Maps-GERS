...
This Clause defines requirements classes with a standardization target of an implementation of the GERS Framework. Specifically, requirements defined in this clause are focused on the elements of the model required or recommended to implement the Framework consistent with the existing GERS implementation community. This clause does not define requirements for conflation, work flows, or storage/processing technologies.
