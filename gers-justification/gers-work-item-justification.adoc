...
The proposed OGC GERS Community Standard will have limited focus on the logical model for a GERS framework as documented in the current Overture data, bridge, change log, reference map, and registry schemas. This focus defines a standard that can be implemented by any organization that will be 100% consistent with the existing Overture Maps Foundation implementation of the GERS framework but "owned" by the implementing organization.
...
The following components of the Global Entity Reference System are addressed in the GERS Community Standard. The source of the content for the draft Community Standard is the July 2025 of the Overture GERS release.
