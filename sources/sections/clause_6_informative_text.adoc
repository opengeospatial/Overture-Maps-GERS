...
|Places	    | place | There are over 2100 subtypes, also know as https://github.com/OvertureMaps/schema/blob/main/docs/schema/concepts/by-theme/places/overture_categories.csv[categories], defined.
