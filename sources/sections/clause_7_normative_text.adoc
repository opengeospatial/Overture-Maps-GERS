...
Any content stored in a ReferenceMap has a minimum set of metadata and properties. The minimum set of metadata/properties 
is the same for all themes and types in a GER framework compliant ReferenceMap. The minimum set of metadata/properties 
