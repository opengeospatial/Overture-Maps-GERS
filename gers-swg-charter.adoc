...
- Feature Types: The source Overture JSON schema provide type enumerations for the base themes, such as land cover types. The OGC GERS Standard will define how all theenumarations ontained in the schema can be extended while maintaining backwards compatability.
