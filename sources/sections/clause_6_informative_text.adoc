...
In terms of implementation, the GERS framework described below is very flexible and extensible. Following are implementation some use cases ranging from the very simple to more complete implementation of the framework.
